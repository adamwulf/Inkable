...
class SavitzkyGolayTests: XCTestCase {
    ...
    func testCoeffs() {
        let coeffs = Coeffs(index: 0)
        let order = 3
        let deriv = 0

        Coeffs.testCoeff(deriv: deriv)

        // window = 2
        XCTAssertEqual(coeffs.weight(-2, 2, order, deriv), -0.08571428571428569)
        XCTAssertEqual(coeffs.weight(-1, 2, order, deriv), 0.34285714285714286)
        XCTAssertEqual(coeffs.weight(0, 2, order, deriv), 0.4857142857142857)
        XCTAssertEqual(coeffs.weight(1, 2, order, deriv), 0.34285714285714286)
        XCTAssertEqual(coeffs.weight(2, 2, order, deriv), -0.08571428571428569)

        // window = 3
        XCTAssertEqual(coeffs.weight(-3, 3, order, deriv), -0.0952380952380952)
        XCTAssertEqual(coeffs.weight(-2, 3, order, deriv), 0.14285714285714288)
        XCTAssertEqual(coeffs.weight(-1, 3, order, deriv), 0.2857142857142857)
        XCTAssertEqual(coeffs.weight(0, 3, order, deriv), 0.33333333333333337)
        XCTAssertEqual(coeffs.weight(1, 3, order, deriv), 0.2857142857142857)
        XCTAssertEqual(coeffs.weight(2, 3, order, deriv), 0.14285714285714288)
        XCTAssertEqual(coeffs.weight(3, 3, order, deriv), -0.0952380952380952)

        // window = 4
        XCTAssertEqual(coeffs.weight(-4, 4, order, deriv), -0.09090909090909091)
        XCTAssertEqual(coeffs.weight(-3, 4, order, deriv), 0.060606060606060615)
        XCTAssertEqual(coeffs.weight(-2, 4, order, deriv), 0.16883116883116883)
        XCTAssertEqual(coeffs.weight(-1, 4, order, deriv), 0.2337662337662338)
        XCTAssertEqual(coeffs.weight(0, 4, order, deriv), 0.2554112554112554)
        XCTAssertEqual(coeffs.weight(1, 4, order, deriv), 0.2337662337662338)
        XCTAssertEqual(coeffs.weight(2, 4, order, deriv), 0.16883116883116883)
        XCTAssertEqual(coeffs.weight(3, 4, order, deriv), 0.060606060606060615)
        XCTAssertEqual(coeffs.weight(4, 4, order, deriv), -0.09090909090909091)
        ...
        // window = 12
        XCTAssertEqual(coeffs.weight(-12, 12, order, deriv), -0.04888888888888888)
        XCTAssertEqual(coeffs.weight(-11, 12, order, deriv), -0.026666666666666665)
        XCTAssertEqual(coeffs.weight(-10, 12, order, deriv), -0.0063768115942028775)
        XCTAssertEqual(coeffs.weight(-9, 12, order, deriv), 0.011980676328502408)
        XCTAssertEqual(coeffs.weight(-8, 12, order, deriv), 0.028405797101449276)
        XCTAssertEqual(coeffs.weight(-7, 12, order, deriv), 0.042898550724637684)
        XCTAssertEqual(coeffs.weight(-6, 12, order, deriv), 0.05545893719806763)
        XCTAssertEqual(coeffs.weight(-5, 12, order, deriv), 0.06608695652173913)
        XCTAssertEqual(coeffs.weight(-4, 12, order, deriv), 0.07478260869565218)
        XCTAssertEqual(coeffs.weight(-3, 12, order, deriv), 0.08154589371980676)
        XCTAssertEqual(coeffs.weight(-2, 12, order, deriv), 0.0863768115942029)
        XCTAssertEqual(coeffs.weight(-1, 12, order, deriv), 0.08927536231884058)
        XCTAssertEqual(coeffs.weight(0, 12, order, deriv), 0.0902415458937198)
        XCTAssertEqual(coeffs.weight(1, 12, order, deriv), 0.08927536231884058)
        XCTAssertEqual(coeffs.weight(2, 12, order, deriv), 0.0863768115942029)
        XCTAssertEqual(coeffs.weight(3, 12, order, deriv), 0.08154589371980676)
        XCTAssertEqual(coeffs.weight(4, 12, order, deriv), 0.07478260869565218)
